...
// New
route.post(
  "/admin/courses/:id/docs",
  verifyToken,
  requireRole("ADMIN"),
  addDocToCourse
);
route.post(
  "/admin/courses/:id/docs/:docId/quizzes",
  verifyToken,
  requireRole("ADMIN"),
  addQuizToDoc
);
route.delete(
  "/admin/courses/:id/docs/:docId",
  verifyToken,
  requireRole("ADMIN"),
  deleteDocFromCourse
);
route.delete(
  "/admin/courses/:id/docs/:docId/quizzes/:quizId",
  verifyToken,
  requireRole("ADMIN"),
  deleteQuizFromDoc
);
